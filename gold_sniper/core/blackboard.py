...
class BlackBoard:
    ...
    def __init__(self) -> None:
        ...
        self._data: dict[str, Any] = {
            ...
            "market_context": build_default_market_context(),
            "visual_layers": {},  # Rempli dynamiquement par VISUAL_LAYERS
        }
    ...
    def get_all_with_visuals(self) -> dict:
        """Retourne l'etat complet + les calques visuels pour le WebSocket."""
        data = self.get_all()

# LEGACY LIVE STRATEGY DICTIONARY - frozen.
# Must be replaced progressively by the unified XAUUSD strategy.
# Phase 0 preserves thresholds, risk, and behavior.
...
from config import TP1_RR, TP2_RR
...
def normalize_session(session: str | None) -> str:
    ...
    if normalized == "LONDON_OPEN":
        return "LONDON"
    if normalized in {"NEW_YORK_OPEN"}:
        return "NY_OPEN"

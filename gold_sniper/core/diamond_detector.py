# LEGACY MANUAL ALERT DETECTOR - FROZEN.
# This module evaluates and alerts diamond setups only; it does not send broker orders.
# Phase 0 preserves behavior; future role is indicator/explanatory signal for the unified pipeline.
